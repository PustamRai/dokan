...
const Navbar = () => {
  ...
  return (
    <nav className="w-full py-4 px-3 md:px-32 flex md:flex-col items-center justify-between bg-gray-50 shadow-sm space-y-2 max-w-[1400px] mx-auto fixed top-0 left-0 right-0 z-50">
      {/* Desktop Navigation */}
